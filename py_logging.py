...
#
# - use py_logging_close() when stopping the py_logging system
#   to ensure that open log file handles are closed
#
# adding new log types to logging.py:
#
...
def py_logging_init(debug = False):
    """
    Initializes the py_logging system
    """
    global _SESSION
